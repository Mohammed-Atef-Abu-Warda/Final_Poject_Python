...
SECRET_KEY = 'django-insecure-rg08rhl&8kt(low2az31q(t=j!)pen-)abfe&(sfu6u1=b3m+z'

# SECURITY WARNING: don't run with debug turned on in production!


# الخيار الأسهل والأضمن لكل المنصات:

ALLOWED_HOSTS = [
    "final-project-python-mohammed.onrender.com",
]
...
# إعدادات الميديا (بما أنك ذكرت وجودها)
MEDIA_URL = '/media/'
